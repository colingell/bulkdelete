<?php
	...
	*/
	...
	function td_event_category() {
			...
			$labels = array(			  
		  	  	'name' => __( 'Genre', 'taxonomy general name' , 'themesdojo'),
		  	  	'singular_name' => __( 'Genre', 'taxonomy singular name' , 'themesdojo'),
		  	  	'search_items' =>  __( 'Search Genres', 'themesdojo'),
		  	  	'all_items' => __( 'All Genres', 'themesdojo' ),
		  	  	'parent_item' => __( 'Parent Genre', 'themesdojo' ),
		  	  	'parent_item_colon' => __( 'Parent Genre:', 'themesdojo' ),
		  	  	'edit_item' => __( 'Edit Genre', 'themesdojo' ), 
		  	  	'update_item' => __( 'Update Genre', 'themesdojo' ),
		  	  	'add_new_item' => __( 'Add New Genre', 'themesdojo' ),
		  	  	'new_item_name' => __( 'New Genre Name', 'themesdojo' ),
		  	); 							  
	...
	***************************************/
	...
	function display_events ($post) { 
		...
		$item_transformation = get_post_meta($post->ID, 'item_transformation', true);
                ...
                // Extra Fields
                $item_night = get_post_meta($post->ID, 'item_night', true);
                $item_featured = get_post_meta($post->ID, 'item_featured', true);
                $item_age = get_post_meta($post->ID, 'item_age', true);
                $item_night = get_post_meta($post->ID, 'item_night', true);
                $item_featured = get_post_meta($post->ID, 'item_featured', true);
                $package_days_amount_event = get_post_meta($post->ID, 'package_days_amount_event', true);
	...
	<div id='options-popup'>
		...
		<div id="property-details">
						...
						<?php	
							...
							if(!empty($my_transactions)) {
								...
								foreach ($my_transactions as $key) {
									...
									$package_days_amount = get_post_meta($transaction_package_id, 'package_days_amount', true);
			...
			<div class="option-item">
				...
				<div class="full">
					<span class='text'><?php _e( 'Location Name', 'themesdojo' ); ?></span>
			...
			<div class="option-item">
				...
				<h3><?php _e( 'Event Information', 'themesdojo' ); ?></h3>

				<div class="full">
					<span class='text'><?php _e( 'Door Price', 'themesdojo' ); ?></span>
					<input style="width: 550px;" type='text' id='eventStatsCrowd' name='eventStatsCrowd' value='<?php if(!empty($item_crowd)) { echo esc_attr($item_crowd); } ?>' placeholder="£10">
					<p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Price at the door in £', 'themesdojo' ); ?></p>
				</div>

				<div class="full">
					<span class='text'><?php _e( 'Guest List Price', 'themesdojo' ); ?></span>
					<input style="width: 550px;" type='text' id='eventStatsInvolvement' name='eventStatsInvolvement' value='<?php if(!empty($item_involvement)) { echo esc_attr($item_involvement); } ?>' placeholder="N/A">
					<p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Price in £ to be added to the guest list', 'themesdojo' ); ?></p>
				</div>

				<div class="full">
					<span class='text'><?php _e( 'Booked Table Price', 'themesdojo' ); ?></span>
					<input style="width: 550px;" type='text' id='eventStatsPreparation' name='eventStatsPreparation' value='<?php if(!empty($item_preparation)) { echo esc_attr($item_preparation); } ?>' placeholder="N/A">
					<p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Price in £ to have a booked table', 'themesdojo' ); ?></p>
				</div>

				<div class="full">
					<span class='text'><?php _e( 'Dress Code', 'themesdojo' ); ?></span>
					<input style="width: 550px;" type='text' id='eventStatsTransformation' name='eventStatsTransformation' value='<?php if(!empty($item_transformation)) { echo esc_attr($item_transformation); } ?>' placeholder="Smart/Casual">
					<p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Dress code of what to wear on the night i.e Smart, Casual, Disco, Beach', 'themesdojo' ); ?></p>
				</div>
					
			

<div class="full">
					<span class='text'><?php _e( 'Age Range', 'themesdojo' ); ?></span>
					<input style="width: 550px;" type='text' id='listingFormAgeRange' name='listingFormAgeRange' value='<?php if(!empty($item_age)) { echo esc_attr($item_age); } ?>' placeholder="21+">
					<p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Age range for the evening i.e 21+, 18-30, Over 30s', 'themesdojo' ); ?></p>
				</div>
					
			

<div class="full">
					<span class='text'><?php _e( 'Late Night Event', 'themesdojo' ); ?></span>
<select id="listingFormLate" name="listingFormLate">														 <option value="Yes" <?php if($item_night=="Yes") echo 'selected="selected"'; ?> >Yes</option>
<option value="No" <?php if($item_night=="No") echo 'selected="selected"'; ?> >No</option> 
</select>
					<div><p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Is this a late night event i.e starts after 4am - Yes/No', 'themesdojo' ); ?></p></div>
				</div>


<div class="full">
					<span class='text'><?php _e( 'Featured Event', 'themesdojo' ); ?></span>
<select id="featuredEvent" name="featuredEvent">														 
<option value="Yes" <?php if($item_featured=="Yes") echo 'selected="selected"'; ?> >Yes</option>
<option value="No" <?php if($item_featured=="No") echo 'selected="selected"'; ?> >No</option>
</select>
					<div><p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'Is this a featured event', 'themesdojo' ); ?></p></div>
				</div>
...
<div class="full">
					<span class='text'><?php _e( 'Days Active', 'themesdojo' ); ?></span>
<select id="packageDaysAmountevent" name="packageDaysAmountevent">
<option value="forever" <?php if($package_days_amount_event=="forever") echo 'selected="selected"'; ?> >forever</option>					 
<option value="1" <?php if($package_days_amount_event=="1") echo 'selected="selected"'; ?> >1</option>
<option value="7" <?php if($package_days_amount_event=="7") echo 'selected="selected"'; ?> >7</option>
<option value="14" <?php if($package_days_amount_event=="14") echo 'selected="selected"'; ?> >14</option>
<option value="30" <?php if($package_days_amount_event=="30") echo 'selected="selected"'; ?> >30</option>
</select>
					<div><p class="help-block" style="margin-top: 5px; margin-left: 0;"><?php _e( 'How many days the post will be active for', 'themesdojo' ); ?></p></div>
				</div>
			...
			<div class="option-item">
				...
				<div class="full">
					<span class='text'><?php _e( 'County', 'themesdojo' ); ?></span>
				...
				<div class="full">
					<span class='text'><?php _e( 'City/Town', 'themesdojo' ); ?></span>
				...
				<div class="full">
					<span class='text'><?php _e( 'Address Line 2', 'themesdojo' ); ?></span>
				...
				<div class="full">
					<span class='text'><?php _e( 'Address Line 1', 'themesdojo' ); ?></span>
				...
				<div class="full">
					<span class='text'><?php _e( 'Postal Code', 'themesdojo' ); ?></span>
	...
	function update_events_settings ( $post_id ) {
		...
		if(isset($_POST['eventStatsTransformation'])) { 
			...
			update_post_meta($post_id, 'item_transformation', $item_transformation);
                ...
                // Extra Fields
		if(isset($_POST['listingFormLate'])) { 
			$item_night = sanitize_text_field($_POST['listingFormLate']);
			update_post_meta($post_id, 'item_night', $item_night);
		}

                if(isset($_POST['featuredEvent'])) { 
			$item_featured = sanitize_text_field($_POST['featuredEvent']);
			update_post_meta($post_id, 'item_featured', $item_featured);
		}

                 if(isset($_POST['packageDaysAmountevent'])) { 
			$package_days_amount_event = sanitize_text_field($_POST['packageDaysAmountevent']);
			update_post_meta($post_id, 'package_days_amount_event', $package_days_amount_event);
		}

                if(isset($_POST['listingFormAgeRange'])) { 
			$item_age = sanitize_text_field($_POST['listingFormAgeRange']);
			update_post_meta($post_id, 'item_age', $item_age);
		}
	...
	***************************************/
	...
	function display_packages ($post) { 
		...
		$package_days_amount = get_post_meta($post->ID, 'package_days_amount', true);

		// Package Capabilities
                $package_allow_feat_list = get_post_meta($post->ID, 'package_allow_feat_list', true);
	...
	<div id='options-popup'>
		...
		<div id="property-details">
			...
			<div class="option-item">
				...
				<span class='text'><?php _e( 'The number of days active', 'themesdojo' ); ?></span>
			



	
				<select id="package_days_amount" name="package_days_amount">
<option value="forever" <?php if($package_days_amount_event=="forever") echo 'selected="selected"'; ?> >forever</option>					 
<option value="1" <?php if($package_days_amount=="1") echo 'selected="selected"'; ?> >1</option>
<option value="7" <?php if($package_days_amount=="7") echo 'selected="selected"'; ?> >7</option>
<option value="14" <?php if($package_days_amount=="14") echo 'selected="selected"'; ?> >14</option>
<option value="30" <?php if($package_days_amount=="30") echo 'selected="selected"'; ?> >30</option>
</select>	
			</div>

		<div class="option-item">

				<h3><?php _e( 'Featured Listing', 'themesdojo' ); ?></h3>
				
				<span class='text overall'><?php _e( 'Featured Listing', 'themesdojo' ); ?></span>
				<input style="margin-left: 10px;" type="checkbox" name="package_allow_feat_list" value="package_allow_feat_list" <?php if(!empty($package_allow_feat_list)) { ?>checked<?php } ?>><span class="checkbox-text"><?php _e( 'Allow', 'themesdojo' ); ?></span>
...
<div class="option-item">
				...
				<span class='text overall'><?php _e( 'Flyer Image', 'themesdojo' ); ?></span>
	...
	function update_packages_settings ( $post_id ) {
		...
		if(isset($_POST['package_days_amount'])) { 
			$package_days_amount = sanitize_text_field($_POST['package_days_amount']); 
		} else {
			$package_days_amount = "";
		}
        update_post_meta($post_id, 'package_days_amount', $package_days_amount);
		...
		update_post_meta($post_id, 'package_allow_feat_image', $package_allow_feat_image);
                ...
                if(isset($_POST['package_allow_feat_list'])) { 
			$package_allow_feat_list = sanitize_text_field($_POST['package_allow_feat_list']); 
		} else {
			$package_allow_feat_list = "";
		}
		update_post_meta($post_id, 'package_allow_feat_list', $package_allow_feat_list);
